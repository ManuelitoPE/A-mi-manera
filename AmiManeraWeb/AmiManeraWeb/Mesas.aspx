                ...
                <div class="tables-layout">
                    ...
                    <div class="table-grid">
                        <asp:Repeater ID="rptTables" runat="server">
                            <ItemTemplate>
                                <a class="table-item <%# GetTableStatusClass(Eval("estado").ToString()) %>" 
                                   href='<%# ResolveUrl("~/PedidoMesa.aspx?idMesa=" + Eval("idMesa")) %>' 
                        ...
                        <ItemTemplate>
                            <div class="reservation-card <%# GetStatusClass(Eval("estadoPedido").ToString()) %>">
                                ...
                                <div class="reservation-details">
                                    <div class="customer-name"><%#GetMeseroName(Eval("trabajador"))%></div>
                    ...
                    <asp:UpdatePanel ID="UpdatePanel2" runat="server">
                        <ContentTemplate>
                            <asp:GridView ID="gvLineaPedido" runat="server"
                                ...
                                OnRowDataBound="gvProductos_RowDataBound" AllowPaging="true"
